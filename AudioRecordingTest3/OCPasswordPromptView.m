...
@implementation OCPasswordPromptView
...
- (id)initWithPrompt:(NSString *)prompt message:(NSString *)message delegate:(id)delegate cancelButtonTitle:(NSString *)cancelTitle acceptButtonTitle:(NSString *)acceptTitle
{
    ...
    if ((self = [super initWithTitle:prompt message:message delegate:delegate cancelButtonTitle:cancelTitle otherButtonTitles:acceptTitle, nil])) {
        ...
        [theTextField setSecureTextEntry:true];
